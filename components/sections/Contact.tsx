      ...
      <Container className="relative">
        <div className="overflow-hidden rounded-xl border border-line bg-surface shadow-xl">
          <div className="grid md:grid-cols-12">
            <div className="border-b border-line bg-brand-50 p-6 dark:bg-brand-950 sm:p-8 md:col-span-5 md:border-b-0 md:border-r lg:p-10">
              ...
              <ButtonLink
                ...
                size="lg"
                // py-3.5 stands in for Button's `h-13`, which isn't a real
                // Tailwind class and so collapses lg buttons to 24px tall.
                className="mt-8 w-full py-3.5 sm:w-auto"
              >
            ...
            <form
              ...
              className="space-y-5 p-6 sm:p-8 md:col-span-7 lg:p-10"
            >
