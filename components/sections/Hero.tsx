    ...
    <section className="pt-section-sm pb-section-sm md:pt-section md:pb-section">
      <Container>
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Jasa buat web, aplikasi, sistem, dan program custom untuk UMKM di Medan, Palu, dan seluruh Indonesia. Landing page mulai Rp 300rb (technical SEO + GEO bundled, dikutip ChatGPT/Gemini/Perplexity), aplikasi POS/ERP/booking mulai Rp 4 juta dengan estimasi build 1 bulan penuh — hasil yang naikin transaksi dan jangkauan pelanggan.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
