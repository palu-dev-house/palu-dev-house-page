...
export default function HargaPage() {
  const meta = buildMeta({
    ...
    description:
      'Harga jasa buat web & jasa buat aplikasi Palu Dev House: Landing Page Rp 300rb–500rb (technical SEO + GEO bundled, dikutip ChatGPT/Gemini/Perplexity), Web Application (POS/ERP/Booking) mulai Rp 4 juta dengan estimasi build 1 bulan penuh + hosting server Indonesia. Domain dibeli terpisah; add-ons domain & hosting transparan.',
    path: '/harga',
  });
